...
public class Runner {
	...
	/*******************************
	 * Handles the process of getting 
	 * input from the user
	 */
	private void takeInput() {
		...
		HashMap<String, String> transitions = eca.getTransitions();
		// Do FST stuff
		performFST(numGenerations, inputCells, transitions);
	 ...
	 */
	public void performFST(int numGenerations, String inputCells, HashMap<String, String> transitions) {
